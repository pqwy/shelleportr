...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7852ad07983fc5fb9f54a64f15b87dd8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "SHELLEPORT!"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [("shelleportr.bash", None)];
                   ...
                   {exec_custom = false; exec_main_is = "shelleportr.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\245l\203\225\202\176\020\191(\b\229\142\020\180\t\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
