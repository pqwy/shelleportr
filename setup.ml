...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c3e9b1cf1edc0b5c4b070459cb37fb2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "Teleport!"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [("teleport.bash", None)];
                   ...
                   {exec_custom = false; exec_main_is = "teleport.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\131\214\231\218\193\241\187\199\0314[\243\165\170\tW";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
